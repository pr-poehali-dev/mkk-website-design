        ...
        {target && (
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">
              Одноразовая ссылка для загрузки фото паспорта, селфи, банковской карты, СНИЛС и согласий. Действует 40 минут, повторно заполнить нельзя. Ссылка также автоматически отправляется клиенту на email.
            </p>
