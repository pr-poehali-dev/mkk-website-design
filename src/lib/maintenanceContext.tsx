...
const MaintenanceContext = createContext<MaintenanceState>({ maintenance: false, siteClosed: false, companyName: DEFAULT_COMPANY_NAME, companyLogoUrl: DEFAULT_COMPANY_LOGO_URL, cabinetBannerUrl: DEFAULT_CABINET_BANNER_URL });
...
export const MaintenanceProvider = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <MaintenanceContext.Provider value={{ maintenance, siteClosed, companyName, companyLogoUrl, cabinetBannerUrl }}>
      {children}
